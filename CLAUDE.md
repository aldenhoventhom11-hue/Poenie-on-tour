...
2. **Versienummer bumpen bij elke oplevering**: zoek `id="home-version"` (tekst zoals `versie 4.5`) en verhoog hem. Thom checkt dit nummer op zijn iPhone om cache-problemen te herkennen. Huidige versie: **4.5**.
